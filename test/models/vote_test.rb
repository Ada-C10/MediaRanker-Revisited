...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(username: 'chris', uid: 8888, provider: 'github', email: "userchris@test.com") }
    let (:user2) { User.new(username: 'joe', uid: 7777, provider: 'github', email: "userjoe@test.com") }
